		...
		unsigned long end, pgprot_t newprot, unsigned long cp_flags)
{
	...
	do {
		...
		if (pte_present(oldpte)) {
			...
			/* Jonggyu: FM2-specific diagnostic for the v6.8.0 delta. This
			 * confirms that UFFD write protection reaches DevDAX PTEs, which
			 * is required before FMLift performs copy-and-remap. */
