...
#define KVM_SET_USER_MEMORY_REGION2 _IOW(KVMIO, 0x49, \
					 struct kvm_userspace_memory_region2)
/* Jonggyu: Delta from upstream Linux v6.8.0. FM2's userspace path needs a
 * huge-page bitmap during FMSync and a base-page bitmap after switchover;
 * these ioctls are the ABI used by QEMU's iterate_shm() path. */
