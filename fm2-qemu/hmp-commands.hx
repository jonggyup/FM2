...
{
        .name       = "migrate_promotion_shm",
        .args_type  = "uri:s,value:i",
        .params     = "uri value",
        .help       = "Continue an incoming migration from an -incoming defer",
        .cmd        = hmp_migrate_promotion_shm,
    },
...
{
        .name       = "migrate_FMSync_start",
        .args_type  = "uri:s,value:i,duration:i?",
        .params     = "uri value [duration]",
        .help       = "Start FM2 FMSync shared-memory migration",
        .cmd        = hmp_migrate_FMSync_start,
    },

SRST
``migrate_FMSync_start`` *uri* *value* [*duration*]
  Start FM2 background synchronization using the shared CXL mapping.
ERST

{
        .name       = "migrate_FMSync_freqctrl",
        .args_type  = "value:l",
        .params     = "interval-us",
        .help       = "Set FM2 FMSync interval in microseconds (0 disables pacing)",
        .cmd        = hmp_migrate_FMSync_freqctrl,
    },

SRST
``migrate_FMSync_freqctrl`` *interval-us*
  Set the interval inserted between background FMSync rounds.
ERST

{
        .name       = "migrate_FMSync_bandctrl",
        .args_type  = "value:l",
        .params     = "bytes-per-second",
        .help       = "Set FM2 FMSync bandwidth cap (0 disables the cap)",
        .cmd        = hmp_migrate_FMSync_bandctrl,
    },

SRST
``migrate_FMSync_bandctrl`` *bytes-per-second*
  Set the background FMSync bandwidth cap.
ERST

{
        .name       = "migrate_FMSync_switchover",
        .args_type  = "",
        .params     = "",
        .help       = "Commit the FM2 FMSync shared-memory handover",
        .cmd        = hmp_migrate_FMSync_switchover,
    },

SRST
``migrate_FMSync_switchover``
  Commit the FM2 shared-memory handover and enter the switchover phase.
ERST

{
        .name       = "migrate_FMLift_start",
        .args_type  = "uri:s,value:i",
        .params     = "uri value",
        .help       = "Start FM2 FMLift promotion",
        .cmd        = hmp_migrate_FMLift_start,
    },

SRST
``migrate_FMLift_start`` *uri* *value*
  Start promoting the supplied DevDAX range into local DRAM.
ERST

{
        .name       = "migrate_FMLift_bandctrl",
        .args_type  = "value:l",
        .params     = "bytes-per-second",
        .help       = "Set FM2 FMLift bandwidth cap (0 disables the cap)",
        .cmd        = hmp_migrate_FMLift_bandctrl,
    },

SRST
``migrate_FMLift_bandctrl`` *bytes-per-second*
  Set the background CXL-to-DRAM promotion bandwidth cap.
ERST


{
        .name       = "migrate_incoming_shm_setup",
        .args_type  = "uri:s,value:i",
        .params     = "uri value",
        .help       = "Continue an incoming migration from an -incoming defer",
        .cmd        = hmp_migrate_incoming_shm_setup,
    },
