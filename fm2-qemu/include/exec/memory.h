...
struct MemoryListener {
    ...
    /**
     * @fmsync_log_sync: Jonggyu's FM2-specific dirty-log hook. It carries
     * the switchover bit because FM2 changes from huge-page to base-page
     * tracking at handoff; upstream @log_sync has no such parameter.
     */
